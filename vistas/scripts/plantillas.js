 ...
 * diez pantallas del panel de administración, la barra lateral de módulos
 * ("#lateral-admin") y la franja superior con "Cerrar sesión"
 * ("#barra-superior-admin"). Es la forma de reutilizar el mismo markup en
 * todas las páginas sin PHP (PHP queda solo para la futura conexión a base de
 * datos, ya no se usa require_once para las vistas).
 *
 ...
 *
 * Hace falta porque el fragmento de la barra es EL MISMO para las diez
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    cargarPlantilla('#barra-superior-admin', '../../componentes/barra-superior-admin.html');
